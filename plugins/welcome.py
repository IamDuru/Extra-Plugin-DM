...
from DuruMusic.utils.database import is_gbanned_user
...
from DuruMusic.utils.functions import check_format, extract_text_and_keyb
...
@app.on_message(filters.command(["delwelcome", "deletewelcome"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
@adminsOnly("can_change_info")
...
@app.on_message(filters.command("getwelcome", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private)
@adminsOnly("can_change_info")
