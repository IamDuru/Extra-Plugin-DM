...
@app.on_message(filters.command("save", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
...
@app.on_message(filters.command("notes", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@capture_err
...
@app.on_message(filters.command("get", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@capture_err
...
@app.on_message(filters.command("delete", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@adminsOnly("can_change_info")
...
@app.on_message(filters.command("deleteall", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@adminsOnly("can_change_info")
