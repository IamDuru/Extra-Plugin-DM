...
@app.on_message(filters.command("ls", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.forwarded & ~filters.via_bot & SUDOERS)
@capture_err
...
@app.on_message(filters.command("rm", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.forwarded & ~filters.via_bot & SUDOERS)
@capture_err
