...
from DuruMusic.utils.keyboard import ikb
from DuruMusic.utils.database import save_filter
from DuruMusic.utils.functions import (
    extract_user,
...
@app.on_message(filters.command(["kick", "skick"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
...
@app.on_message(
    filters.command(["ban", "sban", "tban"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS
)
@adminsOnly("can_restrict_members")
...
@app.on_message(filters.command("unban", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_restrict_members")
...
@app.on_message(
    filters.command(["promote", "fullpromote"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS
)
...
@app.on_message(filters.command("demote", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_promote_members")
...
@app.on_message(filters.command(["unpinall"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
...
@app.on_message(filters.command(["pin", "unpin"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_pin_messages")
async def pin(_, message: Message):
    if not message.reply_to_message:
...
@app.on_message(filters.command(["mute", "tmute"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_restrict_members")
...
@app.on_message(filters.command("unmute", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_restrict_members")
...
@app.on_message(filters.command(["warn", "swarn"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_restrict_members")
...
@app.on_message(filters.command("rmwarns", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_restrict_members")
...
@app.on_message(filters.command("warns", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@capture_err
