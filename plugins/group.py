...
@app.on_message(filters.command("removephoto", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
...
@app.on_message(filters.command("setphoto", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
@adminsOnly("can_change_info")
...
@app.on_message(filters.command("settitle", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
@adminsOnly("can_change_info")
...
@app.on_message(filters.command(["setdiscription", "setdesc"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]))
@adminsOnly("can_change_info")
