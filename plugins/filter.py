...
@app.on_message(filters.command("filter", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
...
@app.on_message(filters.command("filters", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@capture_err
...
@app.on_message(filters.command("stopall", prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & ~filters.private & ~BANNED_USERS)
@adminsOnly("can_change_info")
